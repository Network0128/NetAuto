...
from napalm import get_network_driver  # napalm 라이브러리에서 get_network_driver 함수를 임포트합니다. 네트워크 장비 관리에 사용됩니다.
...
router1.open()  # 네트워크 장비에 연결을 시작합니다.
...
router1.close()  # 네트워크 장비와의 연결을 종료합니다.
